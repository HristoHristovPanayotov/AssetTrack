...
namespace AssetTrackWebProj.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Portable corporate computers.", "Laptops" },
                    { 2, "External displays and screens.", "Monitors" },
                    { 3, "Rack and tower server hardware.", "Servers" }
                });
